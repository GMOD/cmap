...
you want, like JPEG and libpng.  Again, you may already
...
"/usr/local/lib" for files that look like "libgd*," "libjpeg*," and
"libpng*."  If you're using something like RedHat Linux, you could 
try the "locate" command for each of these (without the star as it 
does wildcard searching on its own).
