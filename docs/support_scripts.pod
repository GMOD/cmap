...
=head3 See Also
  ...
  $ perldoc validate_import_file.pl
...
=head2 cmap-fix-map-display-order.pl
...
=head3 Usage
  ...
  $ cmap-fix-map-display-order.pl -d DATASOURCE --ms-accs=msacc1[,msacc2...]

=head3 See Also

  $ perldoc cmap-fix-map-display-order.pl
