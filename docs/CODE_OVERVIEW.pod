...
images using "libgd" for standard image formats like PNG as
...
Bio::GMOD::CMap::Data::[Generic|Oracle].  The "Generic" module
...
This is a view that makes it easier
...
This is a view used for convenience to render the feature correspondence
matrix.
