package Bio::GMOD::CMap::Apache::UserPreferences;

# $Id: UserPreferences.pm,v 1.1 2002-08-23 16:07:18 kycl4rk Exp $
...
Bio::GMOD::CMap::Apache::UserPreferences - save user preferences
...
In httpd.conf:
  ...
  <Location /cmap/viewer>
      PerlInitHandler Bio::GMOD::CMap::Apache::UserPreferences
...
Bio::GMOD::CMap::Constants file and add to the "PREFERENCE_FIELDS".  Also
be sure to set the default values in the "DEFAULT" section of that
file.

=head1 SEE ALSO

L<perl>, Bio::GMOD::CMap::Constants.
